...
function NavigationMenu() {
  ...
  return (
    <>
      ...
      <Link href="/search-engine" passHref>
        <WhiteLink>
          <div className={`dp-center-col ${activeRoute === 'search-engine' ? activeClassName : ''}`}>
            <SearchEngineIcon isActive={activeRoute === 'search-engine'} />
            <div>Search Engine</div>
          </div>
        </WhiteLink>
      </Link>
      <Link href="/scan-pdf" passHref>
        <WhiteLink>
          <div className={`dp-center-col ${activeRoute === 'scan-pdf' ? activeClassName : ''}`}>
            <ScanPdfIcon isActive={activeRoute === 'scan-pdf'} />
            <div>Scan Pdf</div>
          </div>
        </WhiteLink>
      </Link>
